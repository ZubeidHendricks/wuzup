...
class WhatsAppServiceEngine extends BaseEngine implements WhatsAppServiceEngineInterface
{
    ...
    public function processCampaignSchedule()
    {
        ...
        foreach ($responses as $responseKey => $response) {
            ...
            try {
                ...
                } elseif($th instanceof ConnectionException) { // if its connection issue we need to retry
     ...
     * @return EngineResponse
     */
    function requestBusinessProfile($phoneNumberId) {
     ...
     * @return EngineResponse
     */
    function requestUpdateBusinessProfile($request) {
